...
[![Build Status](https://travis-ci.org/emiplegiaqmnpm/aut-dolorem-est.png)](https://travis-ci.org/emiplegiaqmnpm/aut-dolorem-est)

[![Join the chat at https://gitter.im/emiplegiaqmnpm/aut-dolorem-est](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/emiplegiaqmnpm/aut-dolorem-est?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
* 12.02.2014: the current development version has a paranoia bug in the ecc module. The bug was introduced in commit [ac0b3fe0](https://github.com/emiplegiaqmnpm/aut-dolorem-est/commit/ac0b3fe0) and might affect ecc key generation on platforms without a platform random number generator.
